...
public class MainActivity extends AppCompatActivity implements CategoryAdapter.OnTextClickListener {
    ...
    List<FilterModel> filteredBitmap=new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        downloadImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                MediaStore.Images.Media.insertImage(getContentResolver(),filteredBitmap.get(save_pos).getBitmap(),"filteredImage", "changefiltered");
        ...
        switch (categoriesPassData)
        {
            case "Color" :
                filteredBitmap.add(new
                    ...
                    "Mono_1"));
                filteredBitmap.add(new
                        FilterModel(applUT(originalBitmap,BitmapFactory.decodeResource(this.getResources(), R.drawable.mono_2)),
                        "Mono_2"));
                filteredBitmap.add(new
                        FilterModel(applUT(originalBitmap,BitmapFactory.decodeResource(this.getResources(), R.drawable.mono_3)),
                        "Mono_3"));
                filteredBitmap.add(new
                        FilterModel(applUT(originalBitmap,BitmapFactory.decodeResource(this.getResources(), R.drawable.orange_bl_2)),
                        "OB_2"));
                filteredBitmap.add(new
                        FilterModel(applUT(originalBitmap,BitmapFactory.decodeResource(this.getResources(), R.drawable.orange_bl_3)),
                        "OB_3"));
                filteredBitmap.add(new
                        FilterModel(applUT(originalBitmap,BitmapFactory.decodeResource(this.getResources(), R.drawable.orange_neob2)),
                        "OBN_2"));
                filteredBitmap.add(new
                        FilterModel(applUT(originalBitmap,BitmapFactory.decodeResource(this.getResources(), R.drawable.orange_bl_3)),
                        "OBN_3"));
                filteredBitmap.add(new
                        FilterModel(applUT(originalBitmap,BitmapFactory.decodeResource(this.getResources(), R.drawable.mono_gr_1)),
                        "MGreen_1"));
                filteredBitmap.add(new
                        FilterModel(applUT(originalBitmap,BitmapFactory.decodeResource(this.getResources(), R.drawable.mono_gr_2)),
                        "MGreen_2"));
                filteredBitmap.add(new
            ...
            case "Random" :
                ...
                filteredBitmap.add(new
                        ...
                        "Filmic_1"));
                filteredBitmap.add(new
                        FilterModel(applUT(originalBitmap,BitmapFactory.decodeResource(this.getResources(), R.drawable.filmic_2)),
                        "Filmic_2"));
                filteredBitmap.add(new
                        FilterModel(applUT(originalBitmap,BitmapFactory.decodeResource(this.getResources(), R.drawable.filmic_3)),
                        "Filmic_3"));
                filteredBitmap.add(new
                        FilterModel(applUT(originalBitmap,BitmapFactory.decodeResource(this.getResources(), R.drawable.filmic_4)),
                        "Filmic_4"));
                filteredBitmap.add(new
                        FilterModel(applUT(originalBitmap,BitmapFactory.decodeResource(this.getResources(), R.drawable.filmic_5)),
                        "Filmic_5"));
                filteredBitmap.add(new
                        FilterModel(applUT(originalBitmap,BitmapFactory.decodeResource(this.getResources(), R.drawable.filmic_6)),
                        "Filmic_6"));
                filteredBitmap.add(new
                        FilterModel(applUT(originalBitmap,BitmapFactory.decodeResource(this.getResources(), R.drawable.filmic_7)),
                        "Filmic_7"));
                filteredBitmap.add(new
                        FilterModel(applUT(originalBitmap,BitmapFactory.decodeResource(this.getResources(), R.drawable.filmic_8)),
                        "Filmic_8"));
                filteredBitmap.add(new
                        FilterModel(applUT(originalBitmap,BitmapFactory.decodeResource(this.getResources(), R.drawable.filmic_9)),
                        "Filmic_9"));
                filteredBitmap.add(new
            ...
            case "Type" :
                ...
                filteredBitmap.add(new
                        ...
                        "Simple_2"));
                filteredBitmap.add(new
                        FilterModel(applUT(originalBitmap,BitmapFactory.decodeResource(this.getResources(), R.drawable.simple_3)),
                        "Simple_3"));
                filteredBitmap.add(new
                        FilterModel(applUT(originalBitmap,BitmapFactory.decodeResource(this.getResources(), R.drawable.spectrum_1)),
                        "Spectrum_1"));
                filteredBitmap.add(new
                        FilterModel(applUT(originalBitmap,BitmapFactory.decodeResource(this.getResources(), R.drawable.spectrum_2)),
                        "Spectrum_2"));
                filteredBitmap.add(new
                        FilterModel(applUT(originalBitmap,BitmapFactory.decodeResource(this.getResources(), R.drawable.spectrum_3)),
                        "Spectrum_3"));
                filteredBitmap.add(new
                        FilterModel(applUT(originalBitmap,BitmapFactory.decodeResource(this.getResources(), R.drawable.virtual_01)),
                        "Virtual_1"));
                filteredBitmap.add(new
                        FilterModel(applUT(originalBitmap,BitmapFactory.decodeResource(this.getResources(), R.drawable.virtual_02)),
                        "Virtual_2"));
                filteredBitmap.add(new
                        FilterModel(applUT(originalBitmap,BitmapFactory.decodeResource(this.getResources(), R.drawable.virtual_03)),
                        "Virtual_3"));
                filteredBitmap.add(new
                        FilterModel(applUT(originalBitmap,BitmapFactory.decodeResource(this.getResources(), R.drawable.web_01)),
                        "Web_1"));
                filteredBitmap.add(new
                        FilterModel(applUT(originalBitmap,BitmapFactory.decodeResource(this.getResources(), R.drawable.web_02)),
                        "Web_2"));
                filteredBitmap.add(new
    ...
    private void applyFilterOriginalImage() {
        filterAdapter.setOnItemClickListener(new FilterCollectionAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position) {
                   ...
                   change_pos=position;
                   filterAdapter.notifyDataSetChanged();
                   originalImage.setImageBitmap(filteredBitmap.get(position).getBitmap());
